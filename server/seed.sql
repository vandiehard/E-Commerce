...
(1,  1, 'Wireless Bluetooth Headphones',     'wireless-bluetooth-headphones',     'Premium noise-cancelling wireless headphones with 30-hour battery life, deep bass, and crystal-clear audio. Perfect for music lovers and professionals.', 1299000.00, 50,  '["https://images.unsplash.com/photo-1505740420928-5e560c06d30c?w=500"]', 'active'),
...
(6,  1, 'Wireless Gaming Mouse',             'wireless-gaming-mouse',             'Ultra-lightweight wireless gaming mouse with 25K DPI sensor, 70-hour battery, and programmable buttons.', 699000.00,  60,  '["https://images.unsplash.com/photo-1527814050087-37938454eeae?w=500"]', 'active'),
...
(8,  1, 'Noise Cancelling Earbuds',          'noise-cancelling-earbuds',          'True wireless earbuds with active noise cancellation, transparency mode, and wireless charging case.', 1899000.00, 45,  '["https://images.unsplash.com/photo-1590658268037-6bf12f8e4687?w=500"]', 'active'),
...
(15, 2, 'Canvas Sneakers',                  'canvas-sneakers',                  'Classic low-top canvas sneakers with vulcanized rubber sole. Timeless design for everyday wear.', 349000.00,  90,  '["https://images.unsplash.com/photo-1525966222134-fcfaab181990?w=500"]', 'active'),
...
(17, 2, 'Silk Scarf Premium',               'silk-scarf-premium',               '100% mulberry silk scarf with hand-rolled edges. Versatile accessory that can be worn multiple ways.', 299000.00,  75,  '["https://images.unsplash.com/photo-1601924921557-45e8e0e6528c?w=500"]', 'active'),
...
(19, 2, 'Polo Shirt Classic',               'polo-shirt-classic',               'Premium pique cotton polo shirt with embroidered logo, ribbed collar, and two-button placket.', 249000.00,  120, '["https://images.unsplash.com/photo-1625910513413-5fc421e0fd6d?w=500"]', 'active'),
...
-- ============================================================
(21, 3, 'Minimalist Desk Lamp',              'minimalist-desk-lamp',              'LED desk lamp with adjustable brightness, 3 color temperatures, USB charging port, and touch controls.', 299000.00,  45,  '["https://images.unsplash.com/photo-1507473885765-e6ed057ab6fe?w=500"]', 'active'),
...
(27, 3, 'Cotton Bath Towel Set',            'cotton-bath-towel-set',            'Luxurious 600 GSM Egyptian cotton towel set. Includes 2 bath towels, 2 hand towels, and 2 washcloths.', 499000.00,  40,  '["https://images.unsplash.com/photo-1631379366196-5f1e8c4e8b0e?w=500"]', 'active'),
...
(29, 3, 'Bamboo Storage Basket',            'bamboo-storage-basket',            'Handwoven bamboo storage basket with cotton lining. Perfect for organizing blankets, toys, or laundry.', 189000.00,  65,  '["https://images.unsplash.com/photo-1519718616738-8945544e81a3?w=500"]', 'active'),
(30, 3, 'Aroma Diffuser',                   'aroma-diffuser',                   'Ultrasonic essential oil diffuser with 7 LED color lights, auto shut-off, and 300ml water tank.', 279000.00,  70,  '["https://images.unsplash.com/photo-1600612253971-422b1a30ff24?w=500"]', 'active'),
...
(37, 4, 'Cycling Gloves',                    'cycling-gloves',                    'Padded palm cycling gloves with breathable mesh back, silicone grip, and touch-compatible fingertips.', 199000.00,  60,  '["https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=500"]', 'active'),
...
(42, 5, 'Business Strategy Essentials',      'business-strategy-essentials',      'Learn strategic thinking and business planning from top MBA professors. Includes real-world case studies.', 229000.00,  80,  '["https://images.unsplash.com/photo-1553709217-a2bf67f6ddfc?w=500"]', 'active'),
...
(45, 5, 'Digital Marketing Mastery',         'digital-marketing-mastery',         'Complete guide to SEO, social media marketing, email campaigns, and paid advertising strategies.', 249000.00,  70,  '["https://images.unsplash.com/photo-1532012197267-da84d127e765?w=500"]', 'active'),
...
(47, 5, 'Children Story Book Collection',    'children-story-book-collection',    'Beautifully illustrated collection of 20 classic fairy tales and stories for children ages 3-10.', 299000.00,  50,  '["https://images.unsplash.com/photo-1512825459219-2c628bfc7854?w=500"]', 'active'),
(48, 5, 'Photography Handbook',              'photography-handbook',              'Master photography from basics to advanced techniques. Covers composition, lighting, and post-processing.', 219000.00,  60,  '["https://images.unsplash.com/photo-1485470738324-09d98e35ee49?w=500"]', 'active'),
